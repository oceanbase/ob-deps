...
export C_INCLUDE_PATH=${DEP_PATH}/include/apr-1:${DEP_PATH}/include/mxml:${DEP_PATH}/include:$C_INCLUDE_PATH
export CPLUS_INCLUDE_PATH=${DEP_PATH}/include/apr-1:${DEP_PATH}/include/mxml:${DEP_PATH}/include:$CPLUS_INCLUDE_PATH
...
%changelog
* Fri Oct 9 2024 huaixin.lmy
- update oss-c-sdk version from 3.9.2 to 3.11.2
