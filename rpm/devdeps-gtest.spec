Name: %(echo devdeps-gtest$ABI_FLAG)
Version: 1.8.0
...
cmake .. -DCMAKE_BUILD_TYPE=RelWithDebInfo -DCMAKE_INSTALL_PREFIX=%{_tmppath} -DCMAKE_CXX_FLAGS="${ABI_CXXFLAGS}" -DCMAKE_POSITION_INDEPENDENT_CODE=ON -G 'Unix Makefiles'
