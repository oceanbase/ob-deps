Name: %(echo devdeps-apache-arrow$ABI_FLAG)
Version: 20.0.0
...
export CXXFLAGS="-std=c++17 -fPIC -D_GNU_SOURCE ${ABI_CXXFLAGS} -fstack-protector-strong $DISABLE_ATOMIC -gdwarf-4 -flto=thin --gcc-toolchain=${TOOLS_DIR} -fuse-ld=lld -isystem -I/usr/include"
